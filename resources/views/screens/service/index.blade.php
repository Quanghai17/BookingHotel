        ...
        <div class="page_blogs">
            <div class="container">
                <div class="title_module_index">
                    <h2 class="h2">
                        <a href="hoi-nghi-cuoi-hoi.html" title="Hội nghị - cưới hỏi">Hội nghị - cưới hỏi</a>
                    </h2>
                </div>
            </div>
            <div class="container">
                        ...
                        <div class="item_blog_page clearfix">
                            <div class="img-blog">
                                <a class="image-blog" href="{{ route('service.show', $post->slug) }}"
                                    ...
                                    <img src="{{ Voyager::image($post->image) }}"
                                        ...
                                        alt="Tổ chức tiệc hội nghị, hội thảo cao cấp"
                            ...
                            <div class="blog_content">
                                <h3><a href="{{ route('service.show', $post->slug) }}"
                                        title="Tổ chức tiệc hội nghị, hội thảo cao cấp">{{$post->title}}</a></h3>
                            </div>
                        </div>
                    </div>
                    @endforeach
